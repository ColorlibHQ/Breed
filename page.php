 ...
 *  
 */
do_action( 'breed_page_wrp_start' );
 ...
 *
 * @Hooked breed_page_col_start_cb
 *  
 */
do_action( 'breed_page_col_start' );
 ...
 *
 * @Hooked breed_page_col_end_cb
 *  
 */
do_action( 'breed_page_col_end' );
