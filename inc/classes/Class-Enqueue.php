...
class breed_Enqueue {
	...
	public function breed_scripts_enqueue_init() {
		add_action( 'wp_enqueue_scripts', array( $this, 'breed_frontend_enqueue_scripts', ) );
	}

	public function breed_frontend_enqueue_scripts( ) {
