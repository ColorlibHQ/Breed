...
// breed comment template callback
function breed_comment_callback( $comment, $args, $depth ) {
                ...
                <div class="user justify-content-between d-flex">
                    ...
                    <div class="desc">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <p class="date"><?php printf( __('%1$s at %2$s', 'breed'), get_comment_date(),  get_comment_time() ); ?><?php edit_comment_link( esc_html__( '(Edit)', 'breed' ), '  ', '' ); ?></p>
                            </div>
...
add_filter('comment_reply_link', 'breed_replace_reply_link_class');
function breed_replace_reply_link_class( $class ) {
