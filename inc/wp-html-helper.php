...
// image default alt
if( ! function_exists( 'breed_img_default_alt' ) ) {
	function breed_img_default_alt( $url = '' ) {
...
// Image Tag
if( ! function_exists( 'breed_img_tag' ) ) {
	function breed_img_tag( array $args ) {
...
// Anchor Tag
if( ! function_exists( 'breed_anchor_tag' ) ) {
	function breed_anchor_tag( array $args ) {
		
		$default = array(
			'url' 	 		=> '',
			'text' 	 		=> esc_html__( 'Click Here', 'breed' ),
			'target' 		=> '',
			'title' 		=> '',
			'class'  		=> '',
			'id' 	 		=> '',
...
// Heading Tag
if( ! function_exists( 'breed_heading_tag' ) ) {
	function breed_heading_tag( array $args ) {
		
		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => esc_html__( 'Write Something', 'breed' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
			'wrap_after'  => '',
...
// Paragraph Tag
if( ! function_exists( 'breed_paragraph_tag' ) ) {
	function breed_paragraph_tag( array $args ) {
...
// Other Tag
if( ! function_exists( 'breed_other_tag' ) ) {
	function breed_other_tag( array $args ) {
...
// Button Element 
if( ! function_exists( 'breed_button_element ' ) ) {
	function breed_button_element( array $args ) {
		
		$default = array(
			'text' 	 	  => esc_html__( 'Button', 'breed' ),
			'type'   	  => '',
			'class'  	  => '',
			'id' 	 	  => '',
			'wrap_before' => '',
