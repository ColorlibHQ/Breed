 ...
 * @since 1.0
 */
class Breed_Features extends Widget_Base {

	public function get_name() {
		return 'breed-features';
	}

	public function get_title() {
		return __( 'Features', 'breed' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'feature_heading',
            [
                'label' => esc_html__( 'Feature Section Heading', 'breed' ),
            ]
        );
        $this->add_control(
            'sect_title', [
                'label' => esc_html__( 'Section Title', 'breed' ),
        ...
        $this->add_control(
            'sect_subtitle', [
                'label' => esc_html__( 'Section Sub-title', 'breed' ),
        ...
        $this->add_control(
            'section_title_image', [
                'label' => esc_html__( 'Section Title Image', 'breed' ),
		...
		$this->start_controls_section(
			'features_block',
			[
				'label' => __( 'Features', 'breed' ),
			]
		);
		$this->add_control(
            'features_content', [
                'label' => __( 'Create Features', 'breed' ),
                ...
                'fields' => [
                    [
                        ...
                        'type'  => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => __('Learn Online Courses', 'breed')
                    ],
	                [
		                'name'  => 'desc',
		                'label' => __( 'Description', 'breed' ),
		                'type'  => Controls_Manager::TEXTAREA
	                ],
                    [
                        'name'  => 'icon',
                        'label' => __( 'Feature Icon', 'breed' ),
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'icon_bg',
                'label' => __( 'Feature Icon Background Image', 'breed' ),
                'types' => [ 'classic' ],
        ...
        $this->add_control(
            'btn_one_label', [
                'label' => esc_html__( 'Button One Label', 'breed' ),
                'type'  => Controls_Manager::TEXT,
                'label_block' => true,
        ...
        $this->add_control(
            'btn_one_url', [
                'label' => esc_html__( 'Button One URL', 'breed' ),
        ...
        $this->add_control(
            'btn_two_label', [
                'label' => esc_html__( 'Button Two Label', 'breed' ),
                'type'  => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__('Buy Ticket', 'breed')

            ]
        );
        $this->add_control(
            'btn_two_url', [
                'label' => esc_html__( 'Button Two URL', 'breed' ),
                'type'  => Controls_Manager::URL,
                'label_block' => true
        ...
        $this->start_controls_section(
            'style_section_heading', [
                'label' => __( 'Style Section Title', 'breed' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Feature Title ', 'breed' ),
        ...
        $this->add_control(
            'feature_hover_title', [
                'label' => __( 'Feature Hover Title Color', 'breed' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'feature_desc_color', [
                'label' => __( 'Feature Description Color', 'breed' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#797979',
                'selectors' => [
        ...
        $this->add_control(
            'feature_button',
            [
                'label'     => __( 'Feature Button Style ', 'breed' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'feature_btn1_label_color', [
                'label' => __( 'Button One Label Color', 'breed' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#242424',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_label_color', [
                'label' => __( 'Button One Hover Label Color', 'breed' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_border_color', [
                'label' => __( 'Button One Border Color', 'breed' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_border_color', [
                'label' => __( 'Button One Hover Border Color', 'breed' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_bg', [
                'label' => __( 'Button One Background', 'breed' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'feature_btn1_hover_bg', [
                'label' => __( 'Button One Hover Background', 'breed' ),
                'type'  => Controls_Manager::COLOR,
                'default' => '#3b1d82',
                'selectors' => [
        ...
        $this->add_control(
            'feature_button2',
            [
                'label'     => __( 'Feature Button Two Style ', 'breed' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
